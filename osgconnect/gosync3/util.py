...
def mapping_file_db_groups(group):
    # expected_keys = [
    # "Your Name", "Your Email Address", "Project Name",
    # "Short Project Name", "Field of Science", "Field of Science (if Other)",
    # "PI Name", "PI Email", "PI Organization", "PI Department", "Join Date",
    # "Project Contact", "Project Contact Email", "Telephone Number",
    # "Project Description"]
    db_group = {}
    mapping_json_db_keys = {
        "Project Name": "name", "Short Project Name": "short_name",
        "Field of Science": "discipline",
        "Field of Science (if Other)": "other_discipline",
        "PI Name": "pi", "PI Email": "pi_email",
        "PI Organization": "pi_organization", "PI Department": "pi_department",
        "Project Contact": "contact_name", "Join Date": "join_date",
        "Project Contact Email": "contact_email",
        "Project Description": "description",
        "Telephone Number": "phone_number"
    }
    for k, v in mapping_json_db_keys.items():
        db_group[v] = group[k]
    return db_group
