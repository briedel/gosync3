...
from gosync.globus.globus_db import globus_db_hybrid as globus_db
from gosync.util import parse_config, generate_groupid
...
def main(opts):
    ...
    print(go_db.get_globus_group_members())
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", dest="config", default="gosync/configs/gosync.conf",
